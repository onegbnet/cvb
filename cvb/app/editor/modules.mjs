...
export const MODULES = [
  {
    ...
    fields: [
      ...
      { type: 'phone', attributeId: 'phone', labelKey: 'field.basics.phone', validate: 'phone', options: CALLING_CODE_OPTIONS },
  ...
  },
  {
    ...
    fields: [
      { type: 'select', attributeId: 'countryCode', labelKey: 'field.basics.countryCode', options: COUNTRY_CODE_OPTIONS },
